...
function peg$parse(input: string, options?: IParseOptions) {
  ...
  const peg$startRuleFunctions: {[id: string]: any} = { Tree: peg$parseTree };
  let peg$startRuleFunction: () => any = peg$parseTree;
  ...
  const peg$c11 = "<T";
  const peg$c12 = peg$literalExpectation("<T", false);
  const peg$c13 = ">";
  const peg$c14 = peg$literalExpectation(">", false);
  const peg$c15 = function(ccgCat: any, head: any, dtrs: any): any {
      return { type: "T", ccgCat, head, dtrs };
    };
  const peg$c16 = "0";
  const peg$c17 = peg$literalExpectation("0", false);
  const peg$c18 = "1";
  const peg$c19 = peg$literalExpectation("1", false);
  const peg$c20 = function(): any { return int(text()); };
  const peg$c21 = "2";
  const peg$c22 = peg$literalExpectation("2", false);
  const peg$c23 = "<L";
  const peg$c24 = peg$literalExpectation("<L", false);
  const peg$c25 = function(ccgCat: any, modPOSTag: any, origPOSTag: any, word: any, predArgCat: any): any {
