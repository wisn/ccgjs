...
describe('ccg.tree', () => {
  it('ables to retrieve the correct order of words', () => {
    const str = [
      '(<T Sf 1 2>',
      '(<T NP 0 2>',
  ...
  it('supports pretty print', () => {
    ...
    const ccgTree = new CCG.Tree(str);
    const prettyMachineReadableCCG = ccgTree.toString({ pretty: true });

    expect(prettyMachineReadableCCG).toStrictEqual(str);
  });
